...
namespace PiratePanic
{
	...
	public class ProfilePanel : MonoBehaviour
	{
		...
		private async void PopulateDataAsync(IApiUser user)
		{
			...
			IApiStorageObjects personalStorageObjects = await _connection.Client.ReadStorageObjectsAsync(_connection.Session, new IApiReadStorageObjectId[] { personalStorageId });
